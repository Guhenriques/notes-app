...
import { GithubPicker } from "react-color"; // Import the TwitterPicker component
import DeleteForeverOutlinedIcon from "@mui/icons-material/DeleteForeverOutlined";

import ColorLensTwoToneIcon from '@mui/icons-material/ColorLensTwoTone';

const Note = ({ id, text, deleteNote }) => {
  const [bgColor, setBgColor] = useState("#fccb00");
  ...
  const customColors = ["#eb9694", "#fad0c3", "#fef3bd", "#c1e1c5", "#bedadc", "#c4def6", "#bed3f3", "#d4c4fb", "#abb8c3", "#969696"
  ];
